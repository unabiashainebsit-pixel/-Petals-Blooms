## 🌸 PETALS & BLOOMS: A Boutique Florist Website
### BSIT-1J | PLMUN
**Professor:** Rommel Dinoso
...
- Controls colors, fonts, spacing, and overall aesthetic of the website
...
**4. Google Fonts**
**- Used to apply custom typography**
**- Enhances the visual appeal and branding of the website**
...
**Code Editor (e.g., VS Code):** Used to write and edit the code.

**Web Browser (e.g., Chrome):** Used to run and test the website.

**Image Sources (e.g., Unsplash / local images):** Used for product images and visuals.
